...
// Preserve the retail title tick privately and add Start as a conventional
// native shortcut for the existing skippable Crash/C-T-R title animation.
#define MM_Title_ThTick MM_Title_ThTick_Original
#include "230/MM_Title.c"
#undef MM_Title_ThTick
#include "TitleIntroSkip.c"
